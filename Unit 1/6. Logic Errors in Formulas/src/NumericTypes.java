...
public class NumericTypes
{
	public static void main (String [] args)
	{
		...
		average = ((double) SCORE1 + (double) SCORE2) / (double) NUMBER; // Added ()s around score 1 and 2 and casted variables to double
		output = SCORE1 + " and " + SCORE2 + " have an average of "
				+ average;
		System.out.println(output);

		// Convert Fahrenheit temperatures to Celsius
		fToC = (BOILING_IN_F - 32) * 5/9; // Changed from "5/9 * (BOILING_IN_F - 32)"
